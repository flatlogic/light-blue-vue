        ...
        <Widget title="<h6> Inputs </h6>" customHeader settings refresh close>
          <b-form>
            ...
            <b-form-group
              ...
              breakpoint="md"
            >
              <b-form-input class="input-transparent" type="text" id="disabled-field" disabled value="Default value" />
            </b-form-group>
            <b-form-group
              label="Max length"
            ...
            <b-form-group
              ...
              breakpoint="md"
            >
              <b-input-group class="input-group-transparent" id="prepended-field">
            ...
            <b-form-group
              ...
              breakpoint="md"
            >
              <b-input-group class="input-group-transparent" id="password-field">
                <b-input-group-text slot="prepend">
                  <i class="la la-lock" />
                </b-input-group-text>
      ...
      <b-col lg='4' md='12'>
        ...
        >
          <b-form>
            ...
            <b-form-group>
              <b-input-group>
                <b-input-group-text slot="prepend" class="bg-success text-white">
      ...
      <b-col lg="6" md="12">
        <Widget title="<h6>Pickers</h6>" customHeader close refresh settingsInverse>
          ...
          <b-form>
            ...
            <b-form-group>
              <label for="built-in-colorpicker">
                Built-in colorpicker
                <span class="help-block">
                  Every browser contains built-in colorpicker
                </span>
                <b-form-input id="built-in-colorpicker" type="color"></b-form-input>
              </label>
            </b-form-group>
            <b-form-group>
      ...
      <b-col lg="6" md="12">
        <Widget title="<h6> Input <strong>Masks</strong></h6>"
          ...
          <b-form class="form-label-left">
            ...
            <b-form-group label-cols="4"
                          breakpoint="md" label-for="date-mask">
              <div slot="label">
                Date Format
            ...
            <b-form-group label-cols="4"
                          breakpoint="md" label-for="time-mask">
              <div slot="label">
                Time
