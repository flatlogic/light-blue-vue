...
function generateHeatMapData(count: number, yrange: YRange): { x: string; y: number }[] {
  let i = 0
...
export interface ApexMock {
  line: ApexChartConfig
  area: ApexChartConfig
  column: ApexChartConfig
  bar: ApexChartConfig
  mixed: ApexChartConfig
  pie: ApexChartConfig
  donut: ApexChartConfig
  radial: ApexChartConfig
  heatmap: ApexChartConfig
}
...
const mock: ApexMock = {
  ...
  column: {
    ...
    options: {
      ...
      dataLabels: {
        ...
        offsetY: -20,
        style: { fontSize: '12px', colors: [colors.textColor] },
      },
      xaxis: {
        categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
        position: 'bottom',
        labels: { style: { colors: colors.textColor, offsetY: -18 } },
        axisBorder: { show: false },
        axisTicks: { show: false },
      ...
      fill: {
        gradient: {
          ...
          opacityFrom: 1, opacityTo: 1, stops: [50, 0, 100, 100],
        },
      },
      yaxis: {
        axisBorder: { show: false },
        axisTicks: { show: false },
        labels: { show: false, formatter: function(val: number) { return val + '%' } },
      },
      title: {
        text: 'Monthly Inflation in Argentina, 2002',
        offsetY: 450, margin: 0, align: 'center',
  ...
  bar: {
    ...
    options: {
      ...
      stroke: { width: 0 },
      grid: { borderColor: colors.gridLineColor, xaxis: { showLines: false } },
      yaxis: {
        min: -5, max: 5,
      ...
      tooltip: {
        ...
        x: { formatter: function(val: number) { return String(val) } },
        y: { formatter: function(val: number) { return Math.abs(val) + '%' } },
      },
      title: { text: 'Mauritius population pyramid 2011', style: { color: colors.textColor } },
      xaxis: {
        categories: ['85+', '80-84', '75-79', '70-74', '65-69', '60-64', '55-59', '50-54', '45-49', '40-44', '35-39', '30-34', '25-29', '20-24', '15-19', '10-14', '5-9', '0-4'],
        labels: {
          formatter: function(val: string) { return Math.abs(Math.round(Number(val))) + '%' },
  ...
  mixed: {
    ...
    options: {
      ...
      colors: [colors.blue, colors.green, colors.red],
      stroke: { width: [1, 1, 4] },
      title: { text: 'XYZ - Stock Analysis (2009 - 2016)', align: 'left', offsetX: 110, style: { color: colors.textColor } },
      xaxis: {
      ...
      yaxis: [
        { axisTicks: { show: true }, axisBorder: { show: true, color: colors.blue }, labels: { style: { colors: colors.blue } }, title: { text: 'Income (thousand crores)', style: { color: colors.blue } }, tooltip: { enabled: true } },
        { seriesName: 'Income', opposite: true, axisTicks: { show: true }, axisBorder: { show: true, color: colors.green }, labels: { style: { colors: colors.green } }, title: { text: 'Operating Cashflow (thousand crores)', style: { color: colors.green } } },
        { seriesName: 'Revenue', opposite: true, axisTicks: { show: true }, axisBorder: { show: true, color: colors.orange }, labels: { style: { colors: colors.orange } }, title: { text: 'Revenue (thousand crores)', style: { color: colors.orange } } },
      ],
      tooltip: { theme: 'dark', fixed: { enabled: true, position: 'topLeft', offsetY: 30, offsetX: 60 } },
      legend: { horizontalAlign: 'left', offsetX: 40, labels: { colors: [colors.textColor] } },
      grid: { borderColor: colors.gridLineColor },
    },
  },
  pie: {
  ...
  radial: {
    ...
    options: {
      ...
      title: { text: 'Basic Radial Chart', style: { color: colors.textColor } },
      colors: [colors.blue, colors.green, colors.orange, colors.red],
      plotOptions: {
        radialBar: {
          dataLabels: { value: { color: colors.textColor } },
          track: { background: '#000000', opacity: 0.24 },
        },
      },
    },
  },
  heatmap: {
    ...
    options: {
      tooltip: { theme: 'dark' },
      legend: { labels: { colors: [colors.textColor] } },
      xaxis: { labels: { style: { colors: colors.textColor } }, axisBorder: { show: false }, axisTicks: { show: false } },
      yaxis: { labels: { style: { colors: colors.textColor } } },
      plotOptions: {
        heatmap: {
          ...
          colorScale: {
            ranges: [
              { from: -30, to: 5, name: 'low', color: colors.green },
              { from: 6, to: 20, name: 'medium', color: colors.blue },
              { from: 21, to: 45, name: 'high', color: colors.orange },
              { from: 46, to: 55, name: 'extreme', color: colors.red },
            ],
          },
        },
      },
      dataLabels: { enabled: false },
      title: { text: 'HeatMap Chart with Color Range', style: { color: colors.textColor } },
      stroke: { show: false, width: 0 },
      grid: { show: false },
    },
  },
