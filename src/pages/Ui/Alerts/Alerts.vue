<template>
  <div>
    <b-breadcrumb>
      ...
      <b-breadcrumb-item active>UI Alerts</b-breadcrumb-item>
    </b-breadcrumb>
  ...
  data() {
    return {
      alerts: [{
        ...
        id: 'al-4',
        type: 'danger',
        msg: '<span class="fw-semi-bold">Danger:</span> Change this and that and try again. <a class="btn btn-default btn-xs float-end me-1" href="#">Ignore</a> <a class="btn btn-danger btn-xs float-end me-1" href="#">Take this action</a>',
        visible: [true, true, true],
      }],
    };
  },
