...
...
      ...
      <Widget id="Dashboards">
        ...
        <p>
          <router-link class="btn btn-primary me-2" to="/app/main/analytics">Analytics</router-link>
      ...
      <Widget id="E-Commerce">
        ...
        <p>
          <router-link class="btn btn-primary me-2" to="/app/ecommerce/management">Management</router-link>
          <router-link class="btn btn-primary me-2" to="/app/ecommerce/products">List</router-link>
